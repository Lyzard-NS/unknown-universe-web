...
/*if($System->isLoggedIn()){
    $server = $System->Server['SERVER_IP'];
}else {
    if($System->getCurrentServer()){
        $server = $System->Server['SERVER_IP'];
    }else{
        $server = 'Fuck Off';
    }
...
<maps>
    <map id="1" name="1-1" music="0">
        <gameserverIP><?= $server ?></gameserverIP>
    ...
    <map id="16" name="I" scaleFactor="2" music="1">
        <gameserverIP><?= $server ?></gameserverIP>
        <starfield>true</starfield>
        <backgrounds>
            <background typeID="2001" pFactor="10" layer="0" hideLensflare="false" scale="2.5"/>
            <background typeID="1029" pFactor="10" layer="1" isMain="true"/>
            <background typeID="2011" pFactor="8" layer="3" maskID="15" scale="1.6"/>
            <background typeID="2023" pFactor="6" layer="4" maskID="15" scale="1.6"/>
            <background typeID="4001" pFactor="10" layer="5"/>
        </backgrounds>
    </map>
    ...
    <map id="200" name="Lord of War" music="3">
        <gameserverIP><?= $server ?></gameserverIP>
        <starfield>true</starfield>
        <backgrounds>
